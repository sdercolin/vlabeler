...
The tracking ID generated when user enables tracking is a random UUID, which does not contain any personal
information.
...
[source code](https://github.com/sdercolin/vlabeler/tree/main/src/jvmMain/kotlin/com/sdercolin/vlabeler/tracking).
