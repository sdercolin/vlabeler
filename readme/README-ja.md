...
**このプロジェクトは現在ベータ版です。 ヘルプ、提案、問題レポートなどについては、[Discord](https://discord.gg/yrTqG2SrRd) にて承っております。**
...
6. 単一の特定のファイルをインポートしたい場合は、`ファイル` を選択し、そのファイルを選択します。ラベラーによっては、`ファイル` が使用できない場合があります
