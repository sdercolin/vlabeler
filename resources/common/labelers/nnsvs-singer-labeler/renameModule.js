...
let oldWavFile = wavFolder.resolve(module.entries[0].sample)
...
let newWavFile = wavFolder.resolve(newName + '.wav')
let oldLabFile = File.fromPath(module.rawFilePath)
let newLabFile = projectRootDirectory.resolve(labelerParams['labFolderName']).resolve(newName + '.lab')
