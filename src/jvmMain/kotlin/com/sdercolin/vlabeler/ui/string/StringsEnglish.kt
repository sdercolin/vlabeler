...
fun Strings.en(): String = when (this) {
    ...
    PreferencesChartsFundamentalMinFundamental -> "Min fundamental frequency (Hz)"
    PreferencesChartsFundamentalMinFundamentalInvalid -> "Min fundamental must be less than max fundamental."
    PreferencesChartsFundamentalMaxFundamental -> "Max fundamental frequency (Hz)"
    PreferencesChartsFundamentalMaxFundamentalInvalid -> "Max fundamental must be greater than min fundamental."
    PreferencesChartsFundamentalStepNum -> "Step number of fundamental"
    ...
    PreferencesChartsFundamentalMaxHarmonicFrequencyInvalid ->
        "Max harmonic frequency must be greater than min fundamental."
    PreferencesChartsFundamentalErbsStep -> "Sample interval for ERB scale"
    PreferencesChartsFundamentalMinDisplayCorr -> "Min display correlation"
    PreferencesChartsFundamentalMinDisplayCorrInvalid ->
        "Min display correlation must be less than max display correlation."
    PreferencesChartsFundamentalMaxDisplayCorr -> "Max display correlation"
    PreferencesChartsFundamentalMaxDisplayCorrInvalid ->
        "Max display correlation must be greater than min display correlation."
    PreferencesChartsFundamentalDrawReferenceLine -> "Draw reference lines (C)"
