...
fun Strings.zhHans(): String? = when (this) {
    ...
    MenuFileModuleManagementDuplicate -> "创建当前子项目的副本..."
    ModuleOperationAddDefaultName -> "添加子项目"
    ModuleOperationRenameDefaultName -> "重命名当前子项目"
    ModuleOperationRemoveDefaultName -> "删除当前子项目"
    ModuleOperationDuplicateDefaultName -> "创建当前子项目的副本"
    ...
    ActionSetValue1 -> "将参数1设置到光标位置（多条目编辑模式下为光标所在条目的左边界）"
    ActionSetValue2 -> "将参数2设置到光标位置（多条目编辑模式下为光标所在条目的右边界）"
    ...
    ActionSetCurrentEntryLeft -> "将当前条目的左边界设置到光标位置（多条目编辑模式）"
    ActionSetCurrentEntryRight -> "将当前条目的右边界设置到光标位置（多条目编辑模式）"
