...
fun Strings.zhHans(): String? = when (this) {
    ...
    PreferencesChartsFundamentalMinFundamental -> "最小基频（Hz）"
    PreferencesChartsFundamentalMinFundamentalInvalid -> "最小基频必须小于最大基频。"
    PreferencesChartsFundamentalMaxFundamental -> "最大基频（Hz）"
    PreferencesChartsFundamentalMaxFundamentalInvalid -> "最大基频必须大于最小基频。"
    PreferencesChartsFundamentalStepNum -> "基频计算步数"
    PreferencesChartsFundamentalMaxHarmonicFrequency -> "最大谐波频率（Hz）"
    PreferencesChartsFundamentalMaxHarmonicFrequencyInvalid -> "最大谐波频率必须大于最大基频。"
    PreferencesChartsFundamentalErbsStep -> "ERBs采样间隔"
    PreferencesChartsFundamentalMinDisplayCorr -> "最小显示相关度"
    PreferencesChartsFundamentalMinDisplayCorrInvalid -> "最小显示相关度必须小于最大显示相关度。"
    PreferencesChartsFundamentalMaxDisplayCorr -> "最大显示相关度"
    PreferencesChartsFundamentalMaxDisplayCorrInvalid -> "最大显示相关度必须大于最小显示相关度。"
    PreferencesChartsFundamentalDrawReferenceLine -> "绘制参考线（C）"
