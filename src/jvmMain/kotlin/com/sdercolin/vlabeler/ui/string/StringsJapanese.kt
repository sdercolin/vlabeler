...
fun Strings.ja(): String? = when (this) {
    ...
    MenuSettingsTemplatePlugins -> "テンプレート生成プラグイン..."
    MenuHelp -> "ヘルプ"
    ...
    StarterNewTemplatePlugin -> "テンプレート生成プラグイン"
    ...
    StarterNewInputFileDisabled -> "現在選択されているテンプレート生成プラグインは入力ファイルを必要としません。"
    ...
    PrerendererSampleText -> "サンプルファイルをレンダリング %d/%d..."
    ...
    TemplatePluginManagerTitle -> "テンプレート生成プラグイン"
    TemplatePluginManagerImportDialogTitle -> "テンプレート生成プラグインをインポート"
    ...
    PreferencesViewPositionLeft -> "左"
    PreferencesViewPositionRight -> "右"
    PreferencesViewPositionTop -> "上"
    PreferencesViewPositionBottom -> "下"
