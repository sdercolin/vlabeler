...
fun Strings.ja(): String? = when (this) {
    ...
    PreferencesEditorPostEditActionDescription -> "エントリの編集後に実行する動作を設定します。"
    ...
    PreferencesEditorPostEditActionTrigger -> "動作を実行できるパラメータ"
    ...
    PreferencesEditorPostEditActionUseDraggingDescription -> "パラメータをドラッグした時に当該動作を実行します。"
    PreferencesEditorPostEditActionUseCursorSet -> "パラメータをカーソル位置に設定した時"
    PreferencesEditorPostEditActionUseCursorSetDescription ->
        "「パラメータをカーソル位置に設定」ショートカットでパラメータを設定した時に当該動作を実行します。"
