...
fun Strings.ja(): String? = when (this) {
    ...
    PreferencesKeymapDescription -> "キーボード/マウス操作のキーマップをカスタマイズします。"
    PreferencesKeymapKeyAction -> "キーボード操作"
    PreferencesKeymapKeyActionDescription -> "キーボード操作のキーマップをカスタマイズします。"
    PreferencesKeymapMouseClickAction -> "マウスクリック操作"
    PreferencesKeymapMouseClickActionDescription ->
        "マウスクリック操作のキーマップをカスタマイズします。これらの操作は、対応するキーがすべて押されたときにのみトリガーされます。"
    PreferencesKeymapMouseScrollAction -> "マウススクロール操作"
    PreferencesKeymapMouseScrollActionDescription ->
        "マウススクロール操作のキーマップをカスタマイズします。これらの操作は、対応するキーがすべて押されたときにのみトリガーされます。"
    ...
    PreferencesEditorPlayerLockedSettingParameterWithCursorDescription ->
        "キー操作の「パラメータをカーソル位置に設定」でパラメータを設定するときにも、上の連動ドラッグ設定を適用します。"
