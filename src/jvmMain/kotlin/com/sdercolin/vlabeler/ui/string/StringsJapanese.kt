...
fun Strings.ja(): String? = when (this) {
    ...
    PreferencesChartsFundamentalMinFundamental -> "最小基本周波数（Hz）"
    PreferencesChartsFundamentalMinFundamentalInvalid -> "最小基本周波数は最大基本周波数より小さくなければなりません。"
    PreferencesChartsFundamentalMaxFundamental -> "最大基本周波数（Hz）"
    PreferencesChartsFundamentalMaxFundamentalInvalid -> "最大基本周波数は最小基本周波数より大きくなければなりません。"
    PreferencesChartsFundamentalStepNum -> "基本周波数のステップ数"
    PreferencesChartsFundamentalMaxHarmonicFrequency -> "最大調波周波数（Hz）"
    PreferencesChartsFundamentalMaxHarmonicFrequencyInvalid -> "最大調波周波数は最小基本周波数より大きくなければなりません。"
    PreferencesChartsFundamentalErbsStep -> "ERBsのサンプリング間隔"
    PreferencesChartsFundamentalMinDisplayCorr -> "最小表示相関度"
    PreferencesChartsFundamentalMinDisplayCorrInvalid -> "最小表示相関度は最大表示相関度より小さくなければなりません。"
    PreferencesChartsFundamentalMaxDisplayCorr -> "最大表示相関度"
    PreferencesChartsFundamentalMaxDisplayCorrInvalid -> "最大表示相関度は最小表示相関度より大きくなければなりません。"
    PreferencesChartsFundamentalDrawReferenceLine -> "基本周波数の参照線（C）を描画"
