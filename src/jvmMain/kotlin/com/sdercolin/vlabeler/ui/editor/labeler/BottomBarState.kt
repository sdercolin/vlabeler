...
class BottomBarState(
    ...
    val shouldShowModuleNavigation: Boolean,
    val currentModuleIndex: Int,
    val moduleCount: Int,
    val canGoNextModule: Boolean,
    val canGoPreviousModule: Boolean,
    val goNextModule: () -> Unit,
    val goPreviousModule: () -> Unit,
    val openJumpToModuleDialog: () -> Unit,
    val resolution: Int,
...
fun rememberBottomBarState(
    ...
    BottomBarState(
        ...
        shouldShowModuleNavigation = appState.shouldShowModuleNavigation(),
        currentModuleIndex = project.currentModuleIndex,
        moduleCount = project.modules.size,
        canGoNextModule = appState.canGoNextModule,
        canGoPreviousModule = appState.canGoPreviousModule,
        goNextModule = { appState.nextModule() },
        goPreviousModule = { appState.previousModule() },
        openJumpToModuleDialog = { appState.openJumpToModuleDialog() },
